  ...
  <div id="login" class="login">
    ...
    <div class="login-form">
      ...
      <div class="phonenumber-row row">
        ...
        <input type="tel" maxlength="13" id="Phone_number_set" class="username-input" placeholder="핸드폰 번호 등록"></input>
      </div>
      ...
      <div class="password-row row">
        ...
        <input type="password" type="button" maxlength="12" id="password_set" class="password-set" class="input" placeholder="패스워드 등록(12글자 이하)"></input>
      </div>
    </div>


    <div class="call-to-action">
      <button id="signup1-button" type="submit" onclick="location.href='팀등록.html' " >팀 등록</button>
