  ...
  <div id="login" class="login">
    ...
    <div class="login-form">
      <div class="username-row row">
        ...
        <input type="text" id="Phone_number_input" class="username-input" placeholder="핸드폰 번호"></input>
      </div>
      <div class="password-row row">
        ...
        <input type="password" id="password_input" class="password-input" class="input" placeholder="비밀번호"></input>
      </div>
    </div>
    <div class="call-to-action">
      <button onclick="location.href='나의팀정보.html'  id="login-button" type="button">로그인</button>
